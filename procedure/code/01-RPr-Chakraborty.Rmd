...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_dir = "/Users/madeleinegallop/Documents/MachineLearningS23/madgallop.github.io/docs") })
---
...
The maps were made more efficient through the creation of the function 'create_custom_map', which was reused in most of the maps in this reproduction study.
More work can still be done to apply this function to the SaTScan maps as well as the Race Model Residual map.
...
There is a risk of ecological fallacy with this research design, as interpreting county-level statistics as definitive proof of indevidual-level relationships, especially in counties with small populations, can be problematic, especially given that counties are not weighted by population.
